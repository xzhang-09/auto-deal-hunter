...
from auto_deal_hunter.infra.config import EMBEDDING_MODEL, VECTOR_SPACE
from auto_deal_hunter.infra.paths import DEFAULT_EVAL_HOLDOUT_PATH, DEFAULT_VECTORSTORE_PATH, ensure_data_dirs
from auto_deal_hunter.domain.identity import ItemKind
