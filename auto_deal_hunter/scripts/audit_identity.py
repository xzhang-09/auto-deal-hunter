...
Usage:
  python -m auto_deal_hunter.scripts.audit_identity --per-feed 20 --output-json data/identity_audit.json
...
from auto_deal_hunter.ingest.scraper import FEEDS, ScrapedDeal
