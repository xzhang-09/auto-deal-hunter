...
from auto_deal_hunter.infra.config import LLM_MAX_RETRIES, LLM_SEED, LLM_TEMPERATURE, MCP_MODEL
from auto_deal_hunter.core.scoring import best_opportunity
from auto_deal_hunter.core.source_ids import deal_id
from auto_deal_hunter.infra.paths import DEFAULT_VECTORSTORE_PATH, PROJECT_ROOT
...
def _mcp_server_params() -> StdioServerParameters:
    ...
    return StdioServerParameters(
        ...
        args=[str(PROJECT_ROOT / "auto_deal_hunter" / "app" / "mcp_server.py")],
