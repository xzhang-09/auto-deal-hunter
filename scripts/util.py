"""
Evaluation utilities for fine-tuned pricer.
Usage: from scripts.util import evaluate; evaluate(model_predict, test)
"""
import re
import math
...
class Tester:
    ...
    def error_trend_chart(self):
        ...
        fig.update_layout(
            ...
            xaxis_title="Number of Datapoints", yaxis_title="Error ($)",
